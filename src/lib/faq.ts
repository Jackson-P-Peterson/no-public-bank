export const FAQS: { q: string; a: string[] }[] = [
  ...
  {
    q: "Supporters say Prop B “costs nothing” because it has no funding attached. Is that true?",
    a: [
  ...
  {
    q: "Will I be able to open an account at this bank?",
    a: [
  ...
  {
    q: "Didn’t Los Angeles already try this?",
    a: [
  ...
  {
    q: "What about the Bank of North Dakota? Doesn’t that prove public banks work?",
    a: [
  ...
  {
    q: "I support affordable housing and small business. Why would I vote No?",
    a: [
  ...
  {
    q: "Isn’t this just “banks vs. the people”?",
    a: [
  ...
  {
    q: "What happens if Prop B fails?",
    a: [
