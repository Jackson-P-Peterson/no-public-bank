...
type Intent = "volunteer" | "sign" | "updates";
                ...
                <fieldset>
                  ...
                  <div className="mt-2 grid grid-cols-2 gap-2">
                    ...
                    <a
                      ...
                      className="border-2 border-black bg-white px-3 py-3 text-center text-[17px] font-bold text-black transition hover:bg-paper"
                    >
                      Donate
                    </a>
                    <button
